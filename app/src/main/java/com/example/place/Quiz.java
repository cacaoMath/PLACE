...
public class Quiz {
    ...
    private String quizData[][] = {
            ...
            {"151","hollowness","中空","adv"},
            {"152","typography","タイポグラフィ","n"},
            {"153","diameter","直径","n"},
            {"154","camping","キャンプ","v"},
            {"155","snug","気持ちのよい","n"},
            {"156","ignorant","無知な","adj"},
            {"157","injured","負傷した","v"},
            {"158","furious","激怒した","adj"},
            {"159","gibe","あざける","n"},
            {"160","provoke","引き起こす","v"},
            {"161","copulate","交尾する","n"},
            {"162","inspire","奮い立たせる","v"},
            {"163","instrument","道具","n"},
            {"164","lunchroom","簡易食堂","n"},
            {"165","obligation","恩義","n"},
            {"166","epileptic","てんかん患者","adv"},
            {"167","shoplifting","万引き","v"},
            {"168","advocate","提唱者","n"},
            {"169","vain","虚しい","adj"},
            {"170","piercing","ピアス","v"},
            {"171","arsonist","放火犯","adv"},
            {"172","hirsute","毛深い","n"},
            {"173","counterpart","対応するもの","n"},
            {"174","dunce","劣等生","n"},
            {"175","invest","を投資する","v"},
            {"176","escapee","逃亡者","n"},
            {"177","basalt","玄武岩","n"},
            {"178","vanish","消える","v"},
            {"179","site","現場","n"},
            {"180","duodenal","十二指腸の","adv"},
            {"181","persecute","迫害する","v"},
            {"182","halfhearted","冷淡な","v"},
            {"183","consequence","結果","n"},
            {"184","interpret","解釈する","v"},
            {"185","swag","みやげ品","adv"},
            {"186","admixture","混合","n"},
            {"187","immediately","同時に","adv"},
            {"188","detonation","爆発","n"},
            {"189","somnolent","眠い","adv"},
            {"190","tracery","網目模様","n"},
            {"191","depress","落ち込ませる","v"},
            {"192","ignore","無視する","v"},
            {"193","drain","の水を抜く","v"},
            {"194","vocation","天職","n"},
            {"195","investigation","研究","n"},
            {"196","instruction","指示","n"},
            {"197","vague","曖昧な","adj"},
            {"198","crumpet","クランペット","n"},
            {"199","subsequently","その後","adv"},
            {"200","horsemanship","馬術","n"},
